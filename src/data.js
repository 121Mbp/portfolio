...
const timeline = [
  ...
  {
    type: 'company',
    content: '게임빌컴투스플랫폼 웹개발팀 사원',
    date: '2016. 08. - 2017. 02.',
  },
  {
    type: 'company',
    content: '엠텍크루(현 디케이테크인) 멜론 개발팀 매니저',
    date: '2017. 02. - 2018. 06.',
  },
  {
    type: 'company',
    content: '컴투스 플랫폼 웹개발팀 책임',
...
const projects = [
  {
    ...
    role: 'BE 100% (3명)',
    content:
      '미니 프로젝트로 이클립스 CLI에서 Scanner로 입력값을 받아 회원가입, 계좌개설, 입금, 출금, 조회, 계좌이체를 구현하였습니다.',
  ...
  },
  {
    ...
    content:
      '스타벅스 앱을 기반하여 maven에 필요한 라이브러리를 설정 후 SQL은 MyBatis로 연결하여, servlet과 jsp로 동적으로 웹 페이지를 생성하여 구현하였습니다.',
  ...
  },
  {
    ...
    content:
      '컬러를 선택하여 로컬 스토리지에 저장 및 삭제하여 컬러값을 관리할 수 있습니다. 또한 좌측상단 마스타치 {} 로고를 클릭하면 SCSS형태로 변환되어 사용이 가능하도록 구현했습니다.',
  ...
  },
  {
    ...
    content:
      'JPA로 DB테이블 생성 후 리액트에서 axios로 API를 GET, POST, PUT, DELETE하여 Todo List를 구현하였습니다.',
  ...
  },
  {
    ...
    role: 'FE 100%, BE 100%',
    content:
      'Open AI와 스테이블 디퓨전의 API를 연동하여 이미지, 3D모델, 영상을 생성할 수 있도록 구현하였습니다.',
    url: 'https://github.com/121Mbp/gen-ai',
    skill: ['react', 'nextjs', 'css', 'scss', 'git', 'actions'],
  },
  {
